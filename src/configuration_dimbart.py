...
from transformers.models.mbart.configuration_mbart import PretrainedConfig, MBartConfig, MBartOnnxConfig
...
# Copied from transformers.models.bart.configuration_bart.BartOnnxConfig with some minor changes
class DiMBartConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pos_counters = pos_counters
        self.dim_max_position_embeddings = dim_max_position_embeddings
...
class DiMBartOnnxConfig(MBartOnnxConfig):
    pass