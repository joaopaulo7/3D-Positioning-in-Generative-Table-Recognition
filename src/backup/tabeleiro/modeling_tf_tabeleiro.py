...
# Copied from transformers.models.vision_encoder_decoder.modeling_tf_vision_encoder_decoder.TFVisionEncoderDecoderModel with VisionEncoderDecoder->Tabeleiro,vision_encoder_decoder->tabeleiro
class TFTabeleiroModel(TFPreTrainedModel, TFCausalLanguageModelingLoss):
    r"""
    [`TFTabeleiroModel`] is a generic model class that will be instantiated as a transformer architecture
    ...
    load_weight_prefix = "tf_tabeleiro_model"
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers import TFTabeleiroModel, AutoImageProcessor, AutoTokenizer
        ...
        >>> model = TFTabeleiroModel.from_pretrained("ydshieh/vit-gpt2-coco-en")
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        >>> model = TFTabeleiroModel.from_encoder_decoder_pretrained(
        ...     "google/vit-base-patch16-224-in21k", "bert-base-uncased"
        ... )
        >>> # saving model after fine-tuning
        >>> model.save_pretrained("./vit-bert")
        >>> # load fine-tuned model
        >>> model = TFTabeleiroModel.from_pretrained("./vit-bert")
        ```"""
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers import AutoImageProcessor, AutoTokenizer, TFTabeleiroModel
        >>> from PIL import Image
        >>> import requests
        ...
        >>> model = TFTabeleiroModel.from_pretrained("vit-gpt2")
    ...
    def resize_token_embeddings(self, *args, **kwargs):
        raise NotImplementedError(
            "Resizing the embedding layers via the TFTabeleiroModel directly is not supported. "
