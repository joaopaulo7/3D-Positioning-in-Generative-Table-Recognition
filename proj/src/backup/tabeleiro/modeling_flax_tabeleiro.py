...
# Copied from transformers.models.vision_encoder_decoder.modeling_flax_vision_encoder_decoder.FlaxVisionEncoderDecoderModule with VisionEncoderDecoder->Tabeleiro
class FlaxTabeleiroModule(nn.Module):
    config: TabeleiroConfig
...
# Copied from transformers.models.vision_encoder_decoder.modeling_flax_vision_encoder_decoder.FlaxVisionEncoderDecoderModel with VisionEncoderDecoder->Tabeleiro,vision_encoder_decoder->tabeleiro
class FlaxTabeleiroModel(FlaxPreTrainedModel):
    r"""
    [`FlaxTabeleiroModel`] is a generic model class that will be instantiated as a transformer architecture
    ...
    module_class = FlaxTabeleiroModule
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not _do_init:
            raise ValueError(
                "`FlaxTabeleiroModel` cannot be created without initializing, `_do_init` must be `True`."
            )
    ...
    def encode(
        ...
        ```python
        >>> from transformers import AutoImageProcessor, FlaxTabeleiroModel
        ...
        >>> model = FlaxTabeleiroModel.from_encoder_decoder_pretrained(
    ...
    def __call__(
        ...
        ```python
        >>> from transformers import FlaxTabeleiroModel, AutoImageProcessor, AutoTokenizer
        >>> from PIL import Image
        >>> import requests
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers import FlaxTabeleiroModel
        ...
        >>> model = FlaxTabeleiroModel.from_pretrained("./vit-gpt2")
        ```"""
