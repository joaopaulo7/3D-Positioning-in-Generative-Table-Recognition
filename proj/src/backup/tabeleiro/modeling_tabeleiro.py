...
from .configuration_tabeleiro import TabeleiroConfig
from ..vision_encoder_decoder.configuration_vision_encoder_decoder import VisionEncoderDecoderConfig
...
_CONFIG_FOR_DOC = "TabeleiroConfig"
...
VISION_ENCODER_DECODER_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`TabeleiroConfig`]): Model configuration class with all the parameters of the model.
...
# Copied from transformers.models.vision_encoder_decoder.modeling_vision_encoder_decoder.VisionEncoderDecoderModel with VisionEncoderDecoder->Tabeleiro,vision_encoder_decoder->tabeleiro
class TabeleiroModel(PreTrainedModel):
    r"""
    [`TabeleiroModel`] is a generic model class that will be instantiated as a transformer architecture with
    ...
    """
    config_class = TabeleiroConfig
    base_model_prefix = "tabeleiro"
    ...
    def __init__(
        ...
        if config is None:
            config = TabeleiroConfig.from_encoder_decoder_configs(encoder.config, decoder.config)
        else:
            if not isinstance(config, self.config_class | VisionEncoderDecoderConfig):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        ```python
        >>> from transformers import TabeleiroModel, AutoImageProcessor, AutoTokenizer
        ...
        >>> model = TabeleiroModel.from_pretrained("ydshieh/vit-gpt2-coco-en")
        ...
        if from_tf:
            from transformers import TFTabeleiroModel
            ...
            _tf_model = TFTabeleiroModel.from_pretrained(
            ...
            tf_model = TFTabeleiroModel(encoder=encoder, decoder=decoder)
            ...
            with tempfile.TemporaryDirectory() as tmpdirname:
                ...
                model = TabeleiroModel.from_encoder_decoder_pretrained(
        ...
        if kwargs.get("_fast_init", False):
            logger.warning(
                "Fast initialization is currently not supported for TabeleiroModel. "
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers import TabeleiroModel
        ...
        >>> model = TabeleiroModel.from_pretrained("./vit-bert")
        ```"""
        ...
        config = TabeleiroConfig.from_encoder_decoder_configs(encoder.config, decoder.config, **kwargs)
    ...
    def forward(
        ...
        decoder_counters_states: Optional[List] = None,
        **kwargs,
        ...
        ```python
        >>> from transformers import AutoProcessor, TabeleiroModel
        >>> import requests
        >>> from PIL import Image
        >>> import torch

        >>> processor = AutoProcessor.from_pretrained("microsoft/trocr-base-handwritten")
        >>> model = TabeleiroModel.from_pretrained("microsoft/trocr-base-handwritten")
        ...
        #outputs.decoder_counters_states = decoder_outputs.counters_states
        return outputs
    ...
    def prepare_inputs_for_generation(
        self, input_ids, past_key_values=None, attention_mask=None, use_cache=None, encoder_outputs=None, decoder_counters_states = None,**kwargs
    ):
        ...
        input_dict = {
            ...
            "use_cache": use_cache,
            "decoder_counters_states": decoder_counters_states
        }
        return input_dict

    def resize_token_embeddings(self, *args, **kwargs):
        raise NotImplementedError(
            "Resizing the embedding layers via the TabeleiroModel directly is not supported.Please use the"
